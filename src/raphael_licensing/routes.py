...
_db = Path(os.environ.get("RAPHAEL_LICENSING_DB", "/tmp/raphael-licensing.db"))
...
def list_items() -> dict[str, Any]:
    ...
    return {"service": "raphael-licensing", "items": [{"id": r[0], "name": r[1], "body": r[2], "created_at": r[3]} for r in rows]}
